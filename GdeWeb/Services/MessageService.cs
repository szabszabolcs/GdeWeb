...
namespace GdeWeb.Services
{
    ...
    public class MessageService : IMessageService
    {
        ...
        public MessageService(HttpClient httpClient, ILocalStorageService localStorageService)
        {
        ...
        public async Task<ResultModel> AddContactMail(EmailModel model)
        {
            try
            {
                return await SendPostRequest<ResultModel>("api/Mail/AddContactMail", model, false);
            }
